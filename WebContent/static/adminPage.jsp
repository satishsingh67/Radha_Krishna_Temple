...
<head> 
	...
	<link rel="stylesheet"
		href="./css/adminPageCSS.css"> 
	<link rel="stylesheet"
		href="./css/adminResponsive.css"> 
			...
			<div class="modal-body" style="background-color: antiquewhite;">
				<form id="donorFormId">
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
						<label for="exampleInputEmail1">Donation Amount</strong><strong class="text-danger"style="color:red;">*</strong></label>
			...
			<div class="modal-body" style="background-color: antiquewhite;">
				<form id="expenseFormId">
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
						<label for="exampleInputEmail1">Expense Amount</strong><strong class="text-danger"style="color:red;">*</strong></label>
